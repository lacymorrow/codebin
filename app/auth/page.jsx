        ...
        <div className="px-6 h-full w-full absolute top-0 left-0 right-0 bottom-0 grid place-items-center">
            ...
            <div className="grid gap-5">
                <div className="text-center max-w-xs">
                    ...
                    <p className="text-sm text-foreground/80">Login with your GitHub account or Google account to continue!</p>
                </div>
                <div className="grid gap-3 w-full">
                    <GoogleAuth variant="outline" size="lg" className="items-center gap-4"><FcGoogle className="h-4 w-4" />Continue with Google</GoogleAuth>
                    <GithubAuth variant="default" size="lg" className="items-center gap-4">
